...
export function formatHelp(): string {
  return [
    ...
    '/wf list — 查看已保存的 Workflow',
    '/wf run <id> [JSON输入] — 启动已保存的 Workflow',
    '/wf stop <id> — 停止该 Workflow 所有运行中的实例',
    '/wf export <id> — 导出 Workflow 清单（可备份或跨节点分享）',
    '/wf import <清单JSON> — 导入 Workflow 清单',
    '/ask @bot <问题> — 向一个或多个 Bot 提问并等待回复（可 @多个 Bot 扇出）',
    '/manager status — 查看 Fleet 的 Bot/Ask/Workflow 状态汇总',
